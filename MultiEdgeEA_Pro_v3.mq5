//+------------------------------------------------------------------+
//|                                         MultiEdgeEA_Pro_v3.mq5   |
//| Clean MQL5 EA: SMA + Donchian + RSI with ATR risk & voting       |
//| Rollover filter removed (no TimeLocal/TimeCurrent).              |
//| Loop vars renamed (no pos/idx/i).                                |
//+------------------------------------------------------------------+
#property strict
